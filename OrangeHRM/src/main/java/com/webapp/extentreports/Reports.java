...
public class Reports {
	...
	public Reports(String reportLocation) {
		...
		extent.attachReporter(htmlReporter);
			...
			public void createTest(Scenario scenario,String  screenShotFile ) throws IOException {
				if(scenario != null) {
					String testname= getScenerioTitle(scenario);
					...
					case FAILED:
						extent.createTest(testname).fail("Failed").addScreenCaptureFromPath(getScreenShotLocation(screenShotFile));
						break;
		...
		private String  getScenerioTitle(Scenario scenario) {
